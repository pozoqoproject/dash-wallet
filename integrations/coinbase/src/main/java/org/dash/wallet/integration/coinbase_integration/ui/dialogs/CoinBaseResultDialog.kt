...
class CoinBaseResultDialog : DialogFragment() {
        ...
        binding.coinbaseBuyDialogMessage.setText(
            if (dashToCoinbase)
                getString(
                    ...
                    coinbaseWallet ?: ""
                ) else getString(R.string.it_could_take_up_to_5_minutes, coinbaseWallet ?: "")
        )
        binding.buyDialogContactCoinbaseSupport.isGone = true
        binding.coinbaseBuyDialogNegativeButton.isGone = true
        binding.coinbaseBuyDialogPositiveButton.setText(R.string.close)
    ...
    private fun setTransferPozoqoSuccess(dashToCoinbase: Boolean) {
        ...
        binding.coinbaseBuyDialogMessage.setText(
            if (dashToCoinbase)
                R.string.it_could_take_up_to_10_minutes_to_coinbase else R.string.it_could_take_up_to_10_minutes
        )
        binding.buyDialogContactCoinbaseSupport.isGone = true
        binding.coinbaseBuyDialogNegativeButton.isGone = true
        binding.coinbaseBuyDialogPositiveButton.setText(R.string.close)
