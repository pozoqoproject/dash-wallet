...
class ExploreViewModelTest {
    private val merchants = listOf(
            ...
            Merchant(plusCode = "", addDate = "2021-09-10 11:24", updateDate = "2021-09-10 12:24", deeplink = "", paymentMethod = "dash").apply { id = 3; name = "Bark Box"; active = true; address1 = "Address1 3"; address2 = "Address2 3"; address3 = "Address3 3"; address4 = "Address4 3 Houston"; latitude = 35.223312; longitude = -119.130063; territory = "Texas"; website = ""; phone = ""; type = "physical"; logoLocation = "" },
            ...
            Merchant(plusCode = "", addDate = "", updateDate = "", deeplink = "https://dashdirect.page.link/AMC", paymentMethod = "gift card").apply { id = 19630; name = "AMC Theatres"; active = true; address1 = "3760 Princeton Lakes Pkwy."; latitude = 33.658332; longitude = -84.5100182; website = "http://www.amctheatres.com"; territory = "Georgia"; city = "Atlanta"; type = "both"; logoLocation = "https://api.giftango.com/imageservice/Images/042507_logo_600x380.png" },
    ...
    fun filterByTerritoryIsCorrect() {
        runBlocking {
            ...
            val locationState = mock<UserLocationStateInt> {
